                ...
                <div class="row">
                    <div class="col-12">
                                            ...
                                            <tr>
                                                ...
                                                <td> <a type="button" class="btn btn-primary" title="Documentacion"
                                                        ...
                                                        data-bs-target="#bs-example-modal-editar-{{ $integrantes->id_integrante_comite }}"><i
                                                            class="ri-pencil-fill"></i></a> borrar
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre" placeholder="{{ $integrantes->nombre_completo }}"> 
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="fecha_nacimiento" placeholder="{{ $integrantes->fecha_nacimiento }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">Ocupacion</label>
                            <input type="text" class="form-control" name="ocupacion" placeholder="{{ $integrantes->ocupacion }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="domicilio" placeholder="{{ $integrantes->domicilio }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">telefono fijo</label>
                            <input type="number" class="form-control" name="telefono_fijo" placeholder="{{ $integrantes->telefono }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">telefono celular</label>
                            <input type="number" class="form-control" name="telefono_celular" placeholder="{{ $integrantes->celular }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">correo electronico</label>
                            <input type="email" class="form-control" name="correo" placeholder="{{ $integrantes->correo }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">¿En su Municipio donde se puede tener acceso a
                                Internet?</label>
                            <input type="text" class="form-control" name="acceso_internet" placeholder="{{ $integrantes->acceso_internet }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">Observaciones identificacion</label>
                            <input type="text" class="form-control" name="obs_identificacion" placeholder="{{ $integrantes->observacion_identificacion }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">Observaciones fotografia</label>
                            <input type="text" class="form-control" name="obs_fotografia" placeholder="{{ $integrantes->observacion_fotografia }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">Observaciones carta bajo protesta</label>
                            <input type="text" class="form-control" name="obs_carta" placeholder="{{ $integrantes->observacion_carta }}">
                        </div>
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label">observaciones constancia</label>
                            <input type="text" class="form-control" name="obs_constancia" placeholder="{{ $integrantes->observacion_constancia }}">
                        </div>
                        <br>
